    ...
    return (
        <>
            ...
            <Helmet>
                ...
                <meta name="keywords" content="lawyer software sri lanka, legal practice management, attorney billing software, court diary app, trust accounting lawyers, AI legal tools sri lanka, BASL software" />
                <link rel="canonical" href="https://mytracksy.lk/legal" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="LexTracksy | AI Legal Practice Management" />
                <meta property="og:description" content="Smart Court Diary, Trust Accounting, AI Voice Case Minutes. Built for Sri Lankan Attorneys." />
                    ...
                    {`
                        {
                            ...
                            "description": "AI-powered legal practice management software for Attorneys-at-Law in Sri Lanka.",
                            "offers": {
                                "@type": "Offer",
                                "price": "0",
                                "priceCurrency": "LKR"
            ...
            <div className="lex-root">
                ...
                >
                    ...
                    <div className="lex-container" style={{ position: 'relative', zIndex: 2, textAlign: 'center', maxWidth: 900, margin: '0 auto' }}>
                        ...
                        <h1 className="sr lex-hero-headline" style={{
                            ...
                            <span style={{ color: GOLD }}>Let AI Master Your Chambers.</span>
                        </h1>
                        ...
                        <p className="sr lex-hero-sub" style={{
                            ...
                            Manage Court Diaries, automate Client Trust Accounting, and draft legal documents
                            with AI engineered for Sri Lankan Attorneys.
                        </p>
                ...
                {/* ═══════════════════════════════════════════════
                    3. FEATURES GRID — "Built for the Bar"
                ═══════════════════════════════════════════════ */}
                <section id="features" style={{ padding: '120px 0', background: WHITE, position: 'relative' }}>
                    <div className="lex-container">
                        <div className="sr" style={{ textAlign: 'center', marginBottom: 72 }}>
                            ...
                            <p style={{ fontSize: 18, color: GRAY_600, maxWidth: 650, margin: '0 auto', lineHeight: 1.7 }}>
                                Purpose-built tools that understand the unique workflow of Sri Lankan legal practice.
                            </p>
                        </div>
                        ...
                        <div className="lex-grid-3" style={{
                            ...
                            {[
                                {
                                    icon: '📅',
                                    title: 'Smart Court Diary',
                                    desc: 'Detects clashes between Hulftsdorp and Outstation courts. Instant Conflict of Interest checks.',
                                    delay: '0ms',
                                },
                                {
                                    icon: '🏦',
                                    title: 'Trust & Retainer Ledger',
                                    desc: 'Stop mixing client retainers with your operating income. Generate 1-Click PDF Fee Notes to recover out-of-pocket court stamps.',
                                    delay: '100ms',
                                },
                                {
                                    icon: '🎙️',
                                    title: 'AI Case Minutes',
                                    desc: 'Speak your case updates in English or Sinhala as you walk out of the courtroom. The AI formats it and updates your diary offline.',
                                    delay: '200ms',
                                },
                            ].map((card) => (
                                <div
                                    key={card.title}
                                    className="sr lex-feature-card"
                                ...
                                >
                                    ...
                                    <h3 style={{
                                        ...
                                        marginBottom: 14, fontFamily: FONT_HEADING,
                                    }}>
                                        {card.title}
                                    </h3>
                                    <p style={{ fontSize: 16, color: GRAY_600, lineHeight: 1.7 }}>
                                        {card.desc}
                                    </p>
                                </div>
                            ))}
                ...
                <section id="ai-tools" style={{
                    padding: '120px 0', background: NAVY,
                    ...
                    <div className="lex-container" style={{ position: 'relative', zIndex: 1 }}>
                        <div className="sr" style={{ textAlign: 'center', marginBottom: 72 }}>
                            ...
                            <h2 className="lex-section-title" style={{
                                ...
                                letterSpacing: '-0.02em', marginBottom: 20,
                                fontFamily: FONT_HEADING, lineHeight: 1.15,
                            }}>
                                Elite AI Add-Ons
                            </h2>
                            <p style={{ fontSize: 18, color: GRAY_400, maxWidth: 650, margin: '0 auto', lineHeight: 1.7 }}>
                                Powerful AI tools designed to save hours of legal drafting and research.
                            </p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    desc: 'Generate Letters of Demand in seconds, with proper legal formatting and clause references.',
                                    icon: '📜',
                                    delay: '0ms',
                                },
                                {
                                    title: 'Vision AI for Deeds',
                                    desc: 'Extract Title Details from 50-year-old faded deeds using advanced optical recognition.',
                                    icon: '🔍',
                                    delay: '100ms',
                                },
                                {
                                    title: 'Judgment Summarizer',
                                    desc: 'Summarize Supreme Court Judgments instantly into structured, citable briefs.',
                                    icon: '⚡',
                                    delay: '200ms',
                                },
                            ].map((card) => (
                                <div
                                    key={card.title}
                                    className="sr lex-ai-card"
                                    style={{ transitionDelay: card.delay, display: 'flex', flexDirection: 'column' }}
                                >
                                    <div style={{
                                    ...
                                    <p style={{ fontSize: 16, color: GRAY_400, lineHeight: 1.7, flex: 1, marginBottom: 20 }}>
                                        {card.desc}
                                    </p>
                                    <span style={{
                    ...
                    <div className="lex-container">
                        ...
                        <div style={{ textAlign: 'center', marginBottom: 40 }}>
                            ...
                            <p style={{
                                ...
                                AI-powered legal practice management built exclusively for Sri Lankan Attorneys-at-Law.
                            </p>
                        </div>
