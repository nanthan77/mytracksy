    ...
    const landingStructuredData = [
        ...
        },
        {
            ...
            itemListElement: professions.map((profession, index) => ({
                ...
                url: `https://mytracksy.com/${profession.slug}`,
            })),
        },
        {
            '@context': 'https://schema.org',
    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href="https://mytracksy.com/" />
                <link rel="preload" as="image" href="/assets/hero-main.png" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://mytracksy.com/" />
                ...
                />
                <meta property="og:image" content="https://mytracksy.com/assets/og/mytracksy-og-main.png" />
                ...
                <meta
                    ...
                    content="Profession-specific finance, tax-ready exports, and operational workflows for Sri Lankan medical, legal, business, engineering, creator, and photography studio teams."
                />
                <meta name="twitter:image" content="https://mytracksy.com/assets/og/mytracksy-og-main.png" />
            ...
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .skip-nav:focus { top: 0; outline: 3px solid #6366f1; outline-offset: 2px; }
                ...
                *:focus-visible { outline: 2px solid #2563EB; outline-offset: 2px; border-radius: 4px; }
                ...
                /* A11y: Nav link buttons - reset + styled with proper touch target (44px min) */
                ...
                /* A11y: Improved contrast - darker gradient text */
                ...
                /* A11y: Profession card as button - reset card button styles */
            ...
            <div className="lt-c">
                {/* A11y Issue #13: Skip navigation link */}
                <a href="#main-content" className="skip-nav">Skip to main content</a>

                {/* Enterprise Navbar */}
                <nav className={`lt-nav ${navSolid ? 'lt-nav-s' : ''}`} aria-label="Main navigation">
                    <div className="lt-i" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <a href="/" style={{ display: 'flex', alignItems: 'center' }} aria-label="MyTracksy home">
                            <img
                        ...
                        {/* A11y Issue #12: Convert nav <span> to <button> elements */}
                        <div className="nav-links" style={{ display: 'flex', alignItems: 'center', gap: 24 }} role="list">
                            {['Platform', 'Solutions', 'Security', 'Enterprise'].map((link) => {
                                ...
                                return (
                                    <button key={link} className="nav-link-btn" onClick={() => scrollToSection(sectionMap[link])} role="listitem">{link}</button>
                                )
                            })}
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                            {/* A11y Issue #12: Convert Sign In <span> to <button> */}
                ...
                {/* A11y Issue #20: Wrap in <main> landmark */}
                <main id="main-content">
                    ...
                    <header style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', paddingTop: 120, paddingBottom: 80, position: 'relative', overflow: 'hidden', background: 'radial-gradient(circle at top right, rgba(99,102,241,0.08) 0%, transparent 60%), radial-gradient(circle at bottom left, rgba(14,165,233,0.08) 0%, transparent 60%)' }}>
                        ...
                        <div aria-hidden="true" style={{ position: 'absolute', top: '10%', right: '5%', width: 500, height: 500, background: 'linear-gradient(135deg, #e0e7ff, #f8fafc)', borderRadius: '50%', filter: 'blur(80px)', zIndex: -1, animation: 'float-slow 20s ease-in-out infinite' }} />
                        <div aria-hidden="true" style={{ position: 'absolute', bottom: '10%', left: '5%', width: 400, height: 400, background: 'linear-gradient(135deg, #f0fdfa, #f8fafc)', borderRadius: '50%', filter: 'blur(60px)', zIndex: -1, animation: 'float-slow 25s ease-in-out infinite reverse' }} />

                        <div className="lt-i">
                            <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '55% 45%', gap: '4rem', alignItems: 'center' }}>
                                <div style={{ zIndex: 2 }}>
                                    {/* A11y Issue #2: Badge contrast fix - use dark text on light bg */}
                                    <div className="sr" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '8px 16px', borderRadius: 99, background: 'rgba(59,130,246,0.1)', border: '1px solid rgba(59,130,246,0.2)', color: '#1d4ed8', fontSize: 13, fontWeight: 700, letterSpacing: '0.04em', textTransform: 'uppercase', marginBottom: 32 }}>
                                        <span aria-hidden="true" style={{ width: 8, height: 8, borderRadius: '50%', background: '#3b82f6', display: 'inline-block' }} /> Next-Gen Financial Architecture
                                    </div>

                                    {/* A11y Issue #1: Heading contrast - solid dark color */}
                                    ...
                                    {/* A11y Issue #3: Body text contrast fix */}
                                    <p className="sr" style={{ fontSize: 19, color: '#334155', lineHeight: 1.7, marginBottom: 40, maxWidth: 600 }}>
                                        MyTracksy delivers institutional-grade financial intelligence, bespoke operational data structures, and PDPA-ready infrastructure designed for specialized professional sectors in Sri Lanka.
                                    </p>

                                    {/* A11y Issue #9: Hero CTA buttons - already proper buttons */}
                                    <div className="hero-btns sr" style={{ display: 'flex', gap: 16, flexWrap: 'wrap', transitionDelay: '0.1s' }}>
                                        ...
                                        <button onClick={() => scrollToSection('solutions')} className="btn-secondary" style={{ padding: '18px 40px', fontSize: 16 }}>Explore Capabilities</button>
                                    </div>

                                    {/* A11y Issue #4: Stats label contrast fix - darken from #64748b to #475569 */}
                                    <div className="sr" style={{ marginTop: 48, display: 'flex', alignItems: 'center', gap: 32, transitionDelay: '0.2s' }}>
                                        <div>
                                            <div style={{ fontSize: 24, fontWeight: 800, color: '#0f172a', letterSpacing: '-0.02em' }} aria-label="12 plus Supported Industries">12+</div>
                                            <div style={{ fontSize: 13, color: '#475569', fontWeight: 600, textTransform: 'uppercase' }}>Supported Industries</div>
                                        </div>
                                        <div aria-hidden="true" style={{ width: 1, height: 40, background: 'rgba(0,0,0,0.1)' }} />
                                        <div>
                                            <div style={{ fontSize: 24, fontWeight: 800, color: '#0f172a', letterSpacing: '-0.02em' }}>100%</div>
                                            <div style={{ fontSize: 13, color: '#475569', fontWeight: 600, textTransform: 'uppercase' }}>On-Device Encryption</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="hero-image sr" style={{ position: 'relative', transitionDelay: '0.2s', zIndex: 2 }}>
                                    <div style={{ background: '#ffffff', borderRadius: 32, border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0 40px 100px -20px rgba(15,23,42,0.12), 0 20px 40px -20px rgba(0,0,0,0.05)', padding: '12px', position: 'relative' }}>
                                        <div aria-hidden="true" style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginBottom: 12, paddingLeft: 12, paddingTop: 8 }}>
                                        ...
                                        <img
                                            ...
                                            alt="MyTracksy financial dashboard showing income tracking, expense management, and tax-ready exports for Sri Lankan professionals"
                                            loading="eager"
                                            width={1200}
                                            decoding="async"
                    ...
                    {/* Vertical Space */}
                    <div aria-hidden="true" style={{ height: 100, background: 'linear-gradient(to bottom, #fcfcfc, #f1f5f9)' }} />

                    {/* Sector Specific Solutions - A11y Issue #22: Add aria-labelledby */}
                    <section id="solutions" aria-labelledby="solutions-heading" style={{ padding: '120px 0', background: '#f1f5f9', position: 'relative' }}>
                        <div className="lt-i">
                            <div className="sr" style={{ textAlign: 'center', marginBottom: 80 }}>
                                {/* A11y Issue #5: Section heading contrast - already #0f172a which is fine */}
                                <h2 id="solutions-heading" style={{ fontSize: '3rem', fontWeight: 800, color: '#0f172a', letterSpacing: '-0.03em', marginBottom: 24 }}>Industry-Specific Cognitive Engines</h2>
                                <p style={{ fontSize: 18, color: '#334155', maxWidth: 700, margin: '0 auto', lineHeight: 1.7 }}>
                            ...
                            {/* A11y Issue #14: Convert card divs to accessible buttons */}
                            <div className="prof-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 32 }} role="list">
                                {professions.map((prof, i) => (
                                    <div key={i} className="glass-card sr" style={{ transitionDelay: `${i * 50}ms`, position: 'relative', overflow: 'hidden' }} role="listitem">
                                        <button
                                            className="profession-card-btn"
                                            onClick={() => handleProfessionClick(prof.slug)}
                                            aria-label={`Deploy ${prof.name} Module`}
                                            style={{ padding: 32, height: '100%' }}
                                        >
                                            <div aria-hidden="true" style={{ position: 'absolute', top: 0, right: 0, width: 120, height: 120, background: prof.gradient, opacity: 0.05, borderRadius: '0 0 0 100%', pointerEvents: 'none' }} />
                                            ...
                                            <div style={{ width: 80, height: 80, borderRadius: 20, background: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 24, boxShadow: `0 12px 30px -10px ${prof.color}40`, border: `1px solid ${prof.color}20`, overflow: 'hidden' }}>
                                                {getIconUrl(prof.iconMatch) ? (
                                                    ...
                                                    <span aria-hidden="true" style={{ fontSize: 40 }}>{prof.iconMatch === 'icon_creator' ? '🎥' : prof.iconMatch === 'profession_studios' ? '📸' : '📊'}</span>
                                                )}
                                            </div>

                                            <h3 style={{ fontSize: 19, fontWeight: 800, color: '#0f172a', marginBottom: 12, letterSpacing: '-0.02em' }}>{prof.name}</h3>
                                            <p style={{ fontSize: 15, color: '#475569', lineHeight: 1.6, marginBottom: 24, flex: 1 }}>{prof.tagline}</p>

                                            {/* A11y Issue #14: "Deploy Module" accessible link text with proper contrast */}
                                            <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, fontWeight: 700, color: '#0f172a' }}>
                                                Deploy Module
                                                <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                                            </div>
                                        </button>
                                    </div>
                                ))}
                    ...
                    {/* Core Architecture - A11y Issue #22: Add aria-labelledby */}
                    <section id="platform" aria-labelledby="platform-heading" style={{ padding: '140px 0', background: '#0f172a', color: '#ffffff', position: 'relative', overflow: 'hidden' }}>
                        <div aria-hidden="true" style={{ position: 'absolute', top: '-20%', left: '-10%', width: 800, height: 800, background: 'radial-gradient(circle, rgba(99,102,241,0.15) 0%, transparent 60%)', filter: 'blur(100px)', zIndex: 0 }} />
                        <div className="lt-i" style={{ position: 'relative', zIndex: 1 }}>
                            <div className="sr" style={{ textAlign: 'center', marginBottom: 100 }}>
                                {/* A11y Issue #6: Badge contrast fix on dark background */}
                                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '8px 16px', borderRadius: 99, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)', color: '#cbd5e1', fontSize: 13, fontWeight: 700, letterSpacing: '0.04em', textTransform: 'uppercase', marginBottom: 24 }}>System Capabilities</div>
                                <h2 id="platform-heading" className="lt-h1 text-gradient-white" style={{ fontSize: '3.5rem', fontWeight: 800, letterSpacing: '-0.03em', marginBottom: 24 }}>Enterprise-Grade Infrastructure</h2>
                            </div>

                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 40 }}>
                                {[
                                    { title: 'Tax & Regulatory Workflows', desc: 'EPF/ETF calculations, VAT ledgers, and withholding tax workflows designed around Sri Lankan Inland Revenue Department guidelines. Consult your tax advisor for final filings.', icon: '🏛️' },
                                    { title: 'Privacy-First Architecture', desc: 'Financial ledgers are encrypted on-device by default. Designed with role-based access controls, audit logging, and contractual data-protection safeguards.', icon: '🔐' },
                                    ...
                                    <div key={i} className="sr" style={{ background: 'rgba(30,41,59,0.5)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 24, padding: 40, backdropFilter: 'blur(20px)' }}>
                                        <div aria-hidden="true" style={{ fontSize: 40, marginBottom: 24 }}>{ft.icon}</div>
                                        <h3 style={{ fontSize: 22, fontWeight: 700, color: '#f8fafc', marginBottom: 16 }}>{ft.title}</h3>
                                        {/* A11y Issue #10: Dark section card body text - lighten to #cbd5e1 */}
                                        <p style={{ fontSize: 15, color: '#cbd5e1', lineHeight: 1.7 }}>{ft.desc}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    {/* A11y Issue #22: FAQ section with aria-labelledby & Issue #19: Accessible accordion */}
                    <section id="faq" aria-labelledby="faq-heading" style={{ padding: '100px 0', background: '#ffffff', borderTop: '1px solid rgba(15,23,42,0.05)' }}>
                        <div className="lt-i">
                            <div className="sr" style={{ textAlign: 'center', marginBottom: 56 }}>
                                {/* A11y Issue #6: SEARCH-READY badge contrast */}
                                ...
                                <h2 id="faq-heading" style={{ fontSize: '2.9rem', fontWeight: 800, color: '#0f172a', letterSpacing: '-0.03em', marginBottom: 18 }}>
                                    Questions Search Engines And AI Crawlers Can Understand
                                </h2>
                                <p style={{ fontSize: 18, color: '#334155', maxWidth: 760, margin: '0 auto', lineHeight: 1.75 }}>
                            ...
                            {/* A11y Issue #19: Accessible accordion pattern with aria-expanded */}
                                    ...
                                    >
                                        <h3>
                                            <button
                                                ...
                                                aria-expanded={expandedFaq === index || expandedFaq === null}
                                                style={{ background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', width: '100%', fontSize: 19, fontWeight: 750, color: '#0f172a', letterSpacing: '-0.02em', fontFamily: 'inherit', padding: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}
                                            >
                                                {faq.question}
                                                <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0, marginTop: 4, transform: (expandedFaq === index || expandedFaq === null) ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 0.2s' }}><path d="M6 9l6 6 6-6" stroke="#475569" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                                            </button>
                                        </h3>
                                        {/* A11y Issue #7: FAQ answer text contrast fix */}
                                        <div
                                            role="region"
                                            style={{
                                                overflow: 'hidden',
                                                maxHeight: (expandedFaq === index || expandedFaq === null) ? '500px' : '0',
                                                transition: 'max-height 0.3s ease',
                                                marginTop: (expandedFaq === index || expandedFaq === null) ? 12 : 0
                                            }}
                                        >
                    ...
                    {/* Final CTA - A11y Issue #22: Add aria-labelledby */}
                    <section id="enterprise" aria-labelledby="cta-heading" style={{ padding: '120px 0', background: 'linear-gradient(135deg, #f1f5f9 0%, #ffffff 100%)', textAlign: 'center' }}>
                        <div className="lt-i">
                            <div className="sr" style={{ background: 'linear-gradient(135deg, #0f172a, #1e1b4b)', borderRadius: 40, padding: '80px 40px', position: 'relative', overflow: 'hidden', boxShadow: '0 40px 100px -20px rgba(0,0,0,0.2)' }}>
                                <div aria-hidden="true" style={{ position: 'absolute', right: '-10%', top: '-20%', width: 500, height: 500, background: 'radial-gradient(circle, rgba(99,102,241,0.3) 0%, transparent 70%)', borderRadius: '50%', filter: 'blur(60px)' }} />

                                <h2 id="cta-heading" style={{ fontSize: '3.5rem', fontWeight: 800, color: '#ffffff', letterSpacing: '-0.03em', marginBottom: 24, position: 'relative', zIndex: 1 }}>Modernize Your Operations.</h2>
                                <p style={{ fontSize: 18, color: '#cbd5e1', maxWidth: 600, margin: '0 auto 48px', lineHeight: 1.7, position: 'relative', zIndex: 1 }}>
                                    Initiate the deployment of your specialized financial infrastructure. Built for regulatory awareness, intelligence, and data protection.
                                </p>

                                {/* A11y Issue #8: CTA button contrast fix - white bg + dark text = high contrast */}
                                <div style={{ position: 'relative', zIndex: 1 }}>
                                    <button onClick={onGetStarted} className="btn-primary" style={{ padding: '20px 48px', fontSize: 18, background: '#ffffff', color: '#0f172a', fontWeight: 700 }}>
                ...
                {/* Footer - A11y Issue #23: Fix heading hierarchy (H4 → H3) */}
                    ...
                    <div className="lt-i">
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 40, marginBottom: 80 }}>
                            <div style={{ gridColumn: 'span 2' }}>
                                ...
                                {/* A11y Issue #11: Footer text contrast fix */}
                            ...
                            <div>
                                {/* A11y Issue #23: H4 → H3 for proper hierarchy */}
                                <h3 style={{ fontSize: 14, fontWeight: 700, color: '#0f172a', marginBottom: 24 }}>Platform Architecture</h3>
                                {/* A11y Issue #15: Footer links as buttons */}
                                {['Core Infrastructure', 'Security Protocols', 'API Endpoints', 'Regulatory Workflows'].map(l => (
                                    <button key={l} className="footer-link-btn" onClick={() => scrollToSection('platform')}>{l}</button>
                                ))}
                            </div>
                            <div>
                                <h3 style={{ fontSize: 14, fontWeight: 700, color: '#0f172a', marginBottom: 24 }}>Legal & Privacy</h3>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16, paddingTop: 32, borderTop: '1px solid rgba(0,0,0,0.08)' }}>
                            {/* A11y Issue #11: Footer copyright text contrast */}
