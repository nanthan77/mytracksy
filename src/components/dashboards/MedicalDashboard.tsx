                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    ...
                    {!walletData.savedCard && walletData.autoReloadEnabled && (
                        <div style={{ padding: '0.75rem', background: '#fef2f2', borderRadius: 8, fontSize: '0.8rem', color: '#991b1b', border: '1px solid #fecaca' }}>
                            ⚠️ Link a card first to enable auto-reload. <a href="https://wallet.mytracksy.com/link-card" target="_blank" rel="noopener noreferrer" style={{ color: '#6366f1', fontWeight: 600 }}>Link now →</a>
                        </div>
                    )}
                </div>
            </div>
