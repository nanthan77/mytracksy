...
const ProfessionLandingPage: React.FC<ProfessionLandingPageProps> = ({ slug, onGetStarted, onLogin, onBack }) => {
    ...
    if (!route || !content) return <div style={{ padding: 100, textAlign: 'center' }}>Profession not found. <button onClick={onBack}>Go Back</button></div>;

    const color = route.themeColor;
    const plans = [
    ...
    const faqItems = [
        ...
        { q: 'Where is my financial data stored?', a: `All your ${route.name} data stays 100% on your device. We comply with Sri Lankan PDPA regulations. No personal or financial data is ever stored on our servers.` },
        ...
        { q: `Is it built specifically for ${route.shortName}?`, a: `Yes. Every feature, category, report, and tax calculation is tailored for the ${slug === 'personal' ? 'personal finance' : route.name.replace('MyTracksy ', '')} profession in Sri Lanka.` },
    ];
    return (
        <>
            <style>{`
            ...
            <div className="pp-container">
                    ...
                    <div style={{ maxWidth:1200, margin:'0 auto', padding:'0 24px', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
                        <div style={{ display:'flex', alignItems:'center', gap:12 }}>
                            ...
                            <div style={{ display:'flex', alignItems:'center', gap:8 }}>
                                <div style={{ width:32, height:32, borderRadius:9, background:color, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'1rem' }}>{route.icon}</div>
                                <span style={{ fontSize:17, fontWeight:800, color:'#0f172a', letterSpacing:'-0.02em' }}>{route.shortName}</span>
                            </div>
                        </div>
                        <div style={{ display:'flex', alignItems:'center', gap:8 }}>
                    ...
                    <div className="pp-inner">
                        <div className="pp-hero-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'3rem', alignItems:'center' }}>
                            ...
                            <div style={{ opacity:mounted?1:0, transform:mounted?'translateY(0)':'translateY(40px)', transition:'all 1s cubic-bezier(0.16,1,0.3,1) 0.2s' }}>
                                <div style={{ borderRadius:24, overflow:'hidden', background:'linear-gradient(135deg,#0f172a 0%,#1e1b4b 100%)', aspectRatio:'16/10', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', boxShadow:`0 40px 80px -20px ${color}25, 0 0 0 1px ${color}15`, border:'none', position:'relative', cursor:'pointer', transition:'all 0.4s' }}>
                                    ...
                                    <div style={{ width:76, height:76, borderRadius:'50%', background:`linear-gradient(135deg,${color},${color}cc)`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:28, color:'#fff', boxShadow:`0 12px 40px ${color}50`, marginBottom:16, position:'relative', zIndex:2, transition:'transform 0.3s' }}>▶</div>
                                    <div style={{ color:'#fff', fontWeight:700, fontSize:16 }}>Watch Demo</div>
                                    <div style={{ color:'rgba(255,255,255,0.5)', fontSize:13, marginTop:4 }}>See {route.shortName} in action — 2 min</div>
                                    {/* Video URL placeholder — replace src below with actual video */}
                                    {/* <iframe src="YOUR_VIDEO_URL" style={{ position:'absolute', inset:0, width:'100%', height:'100%', border:'none' }} /> */}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="pp-section" style={{ background:'#fafafa' }}>
                    <div className="pp-inner">
                        <div className="pp-sr" style={{ textAlign:'center', marginBottom:56 }}>
                            ...
                            <h2 className="pp-heading" style={{ fontSize:'2.8rem', marginBottom:16 }}>Everything {route.shortName} Needs</h2>
                ...
                <section style={{ padding:'80px 24px', background:'#fff', position:'relative' }}>
                    <div className="pp-inner pp-sr" style={{ maxWidth:720, textAlign:'center' }}>
                        <div style={{ width:80, height:80, borderRadius:24, background:`${color}08`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:40, margin:'0 auto 24px', border:`1px solid ${color}10` }}>{route.icon}</div>
                ...
                <section style={{ padding:'100px 24px', background:`linear-gradient(135deg,${color} 0%,${color}dd 50%,${color}bb 100%)`, textAlign:'center', position:'relative', overflow:'hidden' }}>
                    ...
                    <div className="pp-inner pp-sr" style={{ position:'relative', zIndex:2 }}>
                        <div style={{ fontSize:56, marginBottom:20, filter:'drop-shadow(0 8px 24px rgba(0,0,0,0.2))' }}>{route.icon}</div>
                        <h2 className="pp-heading" style={{ fontSize:'2.8rem', color:'#fff', marginBottom:16, lineHeight:1.2 }}>Ready to Transform Your<br/>{route.name.replace('MyTracksy ','')} Finances?</h2>
                ...
                <footer style={{ padding:'48px 24px', background:'#0f172a', color:'rgba(255,255,255,0.5)', fontSize:13, borderTop:'1px solid rgba(255,255,255,0.05)' }}>
                    <div className="pp-inner" style={{ display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:16 }}>
                        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                            <div style={{ width:28, height:28, borderRadius:8, background:color, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'0.85rem', boxShadow:`0 4px 12px ${color}30` }}>{route.icon}</div>
                            <span style={{ fontWeight:700, color:'#fff', fontSize:14, letterSpacing:'-0.01em' }}>{route.shortName}</span>
                        </div>
                        <div>© 2026 MyTracksy. Built in Sri Lanka 🇱🇰 All data stays on your device.</div>
